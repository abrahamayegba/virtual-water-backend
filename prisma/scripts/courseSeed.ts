  ...
  const coursesData = [
    {
      ...
      description:
        "Learn proper water hygiene practices for safe handling and distribution.",
    ...
    },
    {
      ...
      description:
        "Learn safe practices for handling electrical systems and equipment.",
    ...
    },
    {
      ...
      description:
        "Identify and manage workplace hazards for safety compliance.",
      categoryId: categories[2].id,
      duration: 160,
      CourseObjectives: {
        create: [
...
function createQuiz(
  title: string,
  passingScore: number,
  questions: { question: string; correct: number; options: string[] }[]
) {
  return {
    title,
    passingScore,
